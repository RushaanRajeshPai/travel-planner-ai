...
const OAuth = () => {
  ...
  const fetchCountries = async () => {
    try {
      const response = await fetch('http://localhost:5000/api/auth/countries');
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
